...
class Block(object):
    ...
    def chain_valid(self,chain):
        ...
        while block_index < len(chain):
            ...
            print('The nonce value of Previous Block' , previous_nonce)
            print('The nonce value of Current Block' , current_nonce)
            sha_encoded_value= hashlib.sha256(str(compare_proof).encode())
            print('Conversion of a Proof into String : ' , str(compare_proof).encode())
            print('The Encoding of Compared Value : ' ,sha_encoded_value)
            hex_value= sha_encoded_value.hexdigest()
            print('The Hexadecimal Value of Compared Value : ' , hex_value)
...
if valid:
    print('The Chain Is Validated  . . . . . . ')
else:
    print('The Chain Is Not Validated  . . . . . . ')
