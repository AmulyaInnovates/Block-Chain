...
class Block(object):
    ...
    def chain_valid(self, chain):
        previous_block = chain[0]  # Rectify Chain Value
        block_index = 1  # Rectify block_index Value
        ...
        while block_index < len(chain):
            ...
            compare_proof = current_nonce ** 2 - previous_nonce ** 2  # Rectify compare_proof Value
            ...
            if hash_compare_proof[:4] != '0000':  # Rectify the condition
                return False
